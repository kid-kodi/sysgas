(function () {
    ...
    var injectParams = ['$window', '$scope', '$location', 'societeService', '$timeout', '$routeParams', 'config_map'];

    var societeContratcontroller = function ($window, $scope, $location, societeService, $timeout, $routeParams, config_map) {
        var vm = this;
        ...
        vm.title = null;
        vm.buttonText = null;
        vm.typeContrats = config_map.typeContrats;
        ...
        $scope.$on('app-set-societe', function (event, response) {
            ...
            console.log(response.societe.SelectedTypeContratId);

            //vm.societe = response.societe;
            vm.societeLib = response.societe.societeLib;
            vm.selection = response.societe.selectedTypeContratId;
        });
    ...
    societeContratcontroller.$inject = injectParams;

    angular.module('app').controller('societeContratcontroller', societeContratcontroller);
