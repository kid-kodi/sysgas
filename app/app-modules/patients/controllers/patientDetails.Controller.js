(function () {
    ...
    var injectParams = ['$scope', '$routeParams', 'patientService', '$compile', '$filter'];

    var patientDetailsController = function ($scope, $routeParams, patientService, $compile, $filter) {
        var vm = this,
            patientId = ($routeParams.id) ? parseInt($routeParams.id) : 0;
        ...
        vm.updateCmd = function(commandeId) {
            ...
            patientService.getJsonCommandeById(commandeId);
        };
        ...
        vm.addCommande = function () {
            angular.element(document.getElementById('patientBox'))
            .append($compile("<cmd-form pId='" + patientId + "'></cmd-form>")($scope));
        };
        ...
        vm.setAnalyseForm = function (commandeAnalyseId) {
            patientService.getCommandeAnalyse(commandeAnalyseId);
        };
    ...
    patientDetailsController.$inject = injectParams;
